...
void WalkLegClass::init(LegClass &_leg,float _x0,float _y0,float _L,float _H0,float _t_floor,float _tair_tfloor_scale,float _start_scale_pos,float _delayt_tfloor_scale,int _forward)
{
...
void WalkLegClass::setBezier(float _x0,float _y0,float _L,float _H0,float _tair_tfloor_scale,int _bezierLen,int _forward)
{
    ...
    wx12[8]=-L/2-3*dL;   wx12[9]=-L/2-3*dL;           wx12[10]=-L/2-2*dL;    wx12[11]=-L/2-dL;     wx12[12]=-L/2;
    wy12[0]=0;           wy12[1]=0;                   wy12[2]=0;             wy12[3]=-H0*k;
    wy12[4]=-H0*k;       wy12[5]=-H0*k;               wy12[6]=-H0*k;;        wy12[7]=-H0*k;
    wy12[8]=-H0*k;       wy12[9]=0;                   wy12[10]=0;            wy12[11]=0;           wy12[12]=0;
